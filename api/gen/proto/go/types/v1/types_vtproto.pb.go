...
func (m *RaftDetails) CloneVT() *RaftDetails {
	if m == nil {
		return (*RaftDetails)(nil)
	}
	r := new(RaftDetails)
	r.Leader = m.Leader
	if len(m.unknownFields) > 0 {
...
func (m *RaftDetails) CloneMessageVT() proto.Message {
	return m.CloneVT()
}
...
func (this *LabelSummary) EqualVT(that *LabelSummary) bool {
	...
	if string(this.Hll) != string(that.Hll) {
		return false
	}
	if this.Name != that.Name {
		return false
...
func (this *RaftDetails) EqualVT(that *RaftDetails) bool {
	if this == that {
		return true
	} else if this == nil || that == nil {
		return false
...
func (this *RaftDetails) EqualMessageVT(thatMsg proto.Message) bool {
	that, ok := thatMsg.(*RaftDetails)
	if !ok {
		return false
	}
	return this.EqualVT(that)
...
func (m *LabelSummary) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Hll) > 0 {
		i -= len(m.Hll)
		copy(dAtA[i:], m.Hll)
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.Hll)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *RaftDetails) MarshalVT() (dAtA []byte, err error) {
	if m == nil {
		return nil, nil
	}
	size := m.SizeVT()
...
func (m *RaftDetails) MarshalToVT(dAtA []byte) (int, error) {
	size := m.SizeVT()
	return m.MarshalToSizedBufferVT(dAtA[:size])
}

func (m *RaftDetails) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	if m == nil {
		return 0, nil
	}
	i := len(dAtA)
...
func (m *RaftDetails) SizeVT() (n int) {
	if m == nil {
		return 0
	}
	var l int
...
func (m *RaftDetails) UnmarshalVT(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: RaftDetails: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: RaftDetails: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
