...
func (m *MergeProfilesStacktracesRequest) CloneVT() *MergeProfilesStacktracesRequest {
	...
	r := new(MergeProfilesStacktracesRequest)
...
func (m *MergeProfilesStacktracesResult) CloneVT() *MergeProfilesStacktracesResult {
	...
	r := new(MergeProfilesStacktracesResult)
	r.Format = m.Format
...
func (m *MergeProfilesStacktracesResponse) CloneVT() *MergeProfilesStacktracesResponse {
	...
	r := new(MergeProfilesStacktracesResponse)
	r.SelectedProfiles = m.SelectedProfiles.CloneVT()
...
func (m *SelectSpanProfileRequest) CloneVT() *SelectSpanProfileRequest {
	...
	r := new(SelectSpanProfileRequest)
	r.LabelSelector = m.LabelSelector
	r.Start = m.Start
	r.End = m.End
	r.Hints = m.Hints.CloneVT()
...
func (m *MergeSpanProfileResponse) CloneVT() *MergeSpanProfileResponse {
	...
	r := new(MergeSpanProfileResponse)
	r.SelectedProfiles = m.SelectedProfiles.CloneVT()
	r.Result = m.Result.CloneVT()
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
...
func (m *ProfileSets) CloneVT() *ProfileSets {
	...
	if rhs := m.Fingerprints; rhs != nil {
		tmpContainer := make([]uint64, len(rhs))
		copy(tmpContainer, rhs)
		r.Fingerprints = tmpContainer
	}
	if len(m.unknownFields) > 0 {
		r.unknownFields = make([]byte, len(m.unknownFields))
		copy(r.unknownFields, m.unknownFields)
...
func (m *MergeProfilesLabelsRequest) CloneVT() *MergeProfilesLabelsRequest {
	...
	r := new(MergeProfilesLabelsRequest)
	r.Request = m.Request.CloneVT()
	if rhs := m.By; rhs != nil {
		tmpContainer := make([]string, len(rhs))
		copy(tmpContainer, rhs)
...
func (m *MergeProfilesLabelsResponse) CloneVT() *MergeProfilesLabelsResponse {
	...
	r := new(MergeProfilesLabelsResponse)
	r.SelectedProfiles = m.SelectedProfiles.CloneVT()
...
func (m *MergeProfilesPprofRequest) CloneVT() *MergeProfilesPprofRequest {
	...
	r := new(MergeProfilesPprofRequest)
	r.Request = m.Request.CloneVT()
	if rhs := m.MaxNodes; rhs != nil {
		tmpVal := *rhs
		r.MaxNodes = &tmpVal
...
func (m *MergeProfilesPprofResponse) CloneVT() *MergeProfilesPprofResponse {
	...
	r := new(MergeProfilesPprofResponse)
	r.SelectedProfiles = m.SelectedProfiles.CloneVT()
...
func (m *BlockHints) CloneVT() *BlockHints {
	...
	r := new(BlockHints)
	r.Deduplication = m.Deduplication
...
func (this *ProfileSets) EqualVT(that *ProfileSets) bool {
	...
	if len(this.Fingerprints) != len(that.Fingerprints) {
		return false
	}
	for i, vx := range this.Fingerprints {
		vy := that.Fingerprints[i]
		if vx != vy {
			return false
		}
	}
...
type IngesterServiceClient interface {
	...
	Labels(ctx context.Context, in *v1.LabelsRequest, opts ...grpc.CallOption) (*v1.LabelsResponse, error)
...
func (c *ingesterServiceClient) Labels(ctx context.Context, in *v1.LabelsRequest, opts ...grpc.CallOption) (*v1.LabelsResponse, error) {
	out := new(v1.LabelsResponse)
	err := c.cc.Invoke(ctx, "/ingester.v1.IngesterService/Labels", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type IngesterServiceServer interface {
	...
	Labels(context.Context, *v1.LabelsRequest) (*v1.LabelsResponse, error)
	// Deprecated: ProfileType call is deprecated in the store components
	// TODO: Remove this call in release v1.4
...
func (UnimplementedIngesterServiceServer) Labels(context.Context, *v1.LabelsRequest) (*v1.LabelsResponse, error) {
...
func _IngesterService_Labels_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(v1.LabelsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(IngesterServiceServer).Labels(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ingester.v1.IngesterService/Labels",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(IngesterServiceServer).Labels(ctx, req.(*v1.LabelsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var IngesterService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Labels",
			Handler:    _IngesterService_Labels_Handler,
		},
		{
...
func (m *MergeProfilesStacktracesRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Profiles) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.Profiles)))
		i--
		dAtA[i] = 0x12
	}
	if m.Request != nil {
...
func (m *MergeProfilesStacktracesResult) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.TreeBytes) > 0 {
		...
		i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.TreeBytes)))
		i--
		dAtA[i] = 0x22
	}
	if m.Format != 0 {
	...
	if len(m.FunctionNames) > 0 {
		for iNdEx := len(m.FunctionNames) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.FunctionNames[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *ProfileSets) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Fingerprints) > 0 {
		var pksize2 int
		for _, num := range m.Fingerprints {
...
func (m *SeriesProfile) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if m.LabelIndex != 0 {
		i = protohelpers.EncodeVarint(dAtA, i, uint64(m.LabelIndex))
		i--
		dAtA[i] = 0x8
	}
	return len(dAtA) - i, nil
...
func (m *MergeProfilesLabelsRequest) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.By) > 0 {
		for iNdEx := len(m.By) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.By[iNdEx])))
			i--
			dAtA[i] = 0x12
		}
	}
...
func (m *BlockHints) MarshalToSizedBufferVT(dAtA []byte) (int, error) {
	...
	if len(m.Ulids) > 0 {
		for iNdEx := len(m.Ulids) - 1; iNdEx >= 0; iNdEx-- {
			...
			i = protohelpers.EncodeVarint(dAtA, i, uint64(len(m.Ulids[iNdEx])))
			i--
			dAtA[i] = 0xa
		}
	}
...
func (m *MergeProfilesStacktracesRequest) SizeVT() (n int) {
	...
	if len(m.Profiles) > 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(len(m.Profiles))) + len(m.Profiles)*1
	}
	if m.MaxNodes != nil {
...
func (m *SeriesProfile) SizeVT() (n int) {
	...
	_ = l
	if m.LabelIndex != 0 {
		n += 1 + protohelpers.SizeOfVarint(uint64(m.LabelIndex))
	}
	if m.Timestamp != 0 {
	...
	for iNdEx < l {
		...
		case 3:
			if wireType == 0 {
				...
				m.Fingerprints = append(m.Fingerprints, v)
			} else if wireType == 2 {
				var packedLen int
				for shift := uint(0); ; shift += 7 {
					if shift >= 64 {
				...
				elementCount = count
				if elementCount != 0 && len(m.Fingerprints) == 0 {
					m.Fingerprints = make([]uint64, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v uint64
					for shift := uint(0); ; shift += 7 {
